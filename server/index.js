...
const limiter = rateLimit({
  ...
  message: { error: 'Too Many Requests', message: 'For mange forespørsler fra denne IP-en. Prøv igjen senere.', statusCode: 429 },
...
function gracefulShutdown(signal) {
  ...
  // Ikke vent for alltid — tving avslutning etter 10 sekunder
  setTimeout(() => {
